...
pub fn extract_instructions_with_metadata(
    ...
    match message {
        ...
        VersionedMessage::V0(v0) => {
            let mut account_keys: Vec<Address> = Vec::with_capacity(
                v0.account_keys.len()
...
fn process_instructions<F1, F2>(
    ...
    F1: Fn(&Address, usize) -> bool,
    F2: Fn(&Address, usize) -> bool,
{
...
pub fn transaction_metadata_from_original_meta(
    ...
    Ok(TransactionStatusMeta {
        ...
        log_messages: Some(meta_original.log_messages.unwrap_or_else(Vec::new)),
        ...
        loaded_addresses: {
            ...
            LoadedAddresses {
                writable: loaded
                    .writable
                    .iter()
                    .map(|w| Address::from_str(w).unwrap_or_default())
                    .collect::<Vec<Address>>(),
                readonly: loaded
                    .readonly
                    .iter()
                    .map(|r| Address::from_str(r).unwrap_or_default())
                    .collect::<Vec<Address>>(),
            }
        },
